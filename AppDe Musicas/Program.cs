...
//List<string> listaDasBandas = new List<string> { "U2", "Bibi Fogosa", "Black Eyed Peas"};
Dictionary<string, List<int>> bandasRegistradas = new Dictionary<string, List<int>>();
bandasRegistradas.Add("Bibi Fogosa", new List<int> { 10, 8, 9 });
bandasRegistradas.Add("Black Eyed Peas", new List<int>());
